...
const (
	...
	SELECTOR_ACCEPT_COOKIES_BTN   = "button[aria-label='Accept all']"
	SELECTOR_WHERE_FROM_INPUT     = "div[data-placeholder='Where from?'] input"
	SELECTOR_WHERE_TO_INPUT       = "div[data-placeholder='Where to?'] input"
	SELECTOR_D_DATE_INPUT         = "div[data-enable-prices] input[placeholder='Departure']"
	SELECTOR_R_DATE_INPUT         = "div[data-enable-prices] input[placeholder='Return']"
	SELECTOR_CONFIRM_DATE_BTN     = "button[aria-label='Done. Search for round trip flights, departing on December 3, 2024 and returning on December 7, 2024']"
	SELECTOR_D_CITY               = "Paris"
	SELECTOR_D_CITY_LABEL         = "Paris"
	SELECTOR_A_CITY               = "Rome"
	SELECTOR_A_CITY_LABEL         = "Rome, Italy"
	SELECTOR_SEARCH_BUTTON_SCRIPT = `var btn = document.querySelector("button[aria-label='Search']");
			if (btn == null) {
